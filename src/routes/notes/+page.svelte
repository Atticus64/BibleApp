...
{:else if !loadingNotes && !hasError}
	...
	{:else}
		<ul
			class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 flex max-sm:flex-col flex-row 2xl:flex gap-3 focus:ring-4 focus:outline-none focus:ring-primary-300"
		>
			{#each $notes as note}
				<li
